...
public class BookInfoStatement implements DAORepository<Book> {
    ...
    public void insert(Book book) {
        try {
            String sql= "INSERT INTO book(`book_name`,`book_price`,`book_description`,`book_img`,`book_quantity`,`cat_id`,`author_id`,`publisher_id`) VALUES (?,?,?,?,?,?,?,?)";
    ...
    public ObservableList<Book> getAll() {
        ...
        try {
            ...
            while(rs.next()){
                ...
                book.setBook_quantity (rs.getString( "book_quantity"));
